...
func (arn ARN) String() string {
	...
	return "arn:otterio:sqs:" + arn.region + ":" + arn.TargetID.String()
}
...
func parseARN(s string) (*ARN, error) {
	// ARN must be in the format of arn:otterio:sqs:<REGION>:<ID>:<TYPE>
	if !strings.HasPrefix(s, "arn:otterio:sqs:") {
