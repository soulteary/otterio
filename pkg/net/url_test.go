...
func TestURLString(t *testing.T) {
	testCases := []struct {
		...
		{URL{Scheme: "http", Host: "myotterio:10000", Path: "/mybucket/myobject"}, "http://myotterio:10000/mybucket/myobject"},
...
func TestURLMarshalJSON(t *testing.T) {
	testCases := []struct {
		...
		{URL{Scheme: "http", Host: "myotterio:10000", Path: "/mybucket/myobject"}, []byte(`"http://myotterio:10000/mybucket/myobject"`), false},
...
func TestURLUnmarshalJSON(t *testing.T) {
	testCases := []struct {
		...
		{[]byte(`"http://myotterio:10000/mybucket/myobject//"`), &URL{Scheme: "http", Host: "myotterio:10000", Path: "/mybucket/myobject/"}, false},
...
func TestParseHTTPURL(t *testing.T) {
	testCases := []struct {
		...
		{"http://myotterio:10000/mybucket//myobject/", &URL{Scheme: "http", Host: "myotterio:10000", Path: "/mybucket/myobject/"}, false},
