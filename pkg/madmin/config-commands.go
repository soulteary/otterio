...
// GetConfig - returns the config.json of a otterio setup, incoming data is encrypted.
func (adm *AdminClient) GetConfig(ctx context.Context) ([]byte, error) {
	// Execute GET on /otterio/admin/v3/config to get config of a setup.
...
func (adm *AdminClient) SetConfig(ctx context.Context, config io.Reader) (err error) {
	...
	// Execute PUT on /otterio/admin/v3/config to set config.
