...
// StorageInfo - Connect to a otterio server and call Storage Info Management API
...
// ServerInfo - Connect to a otterio server and call Server Admin Info Management API
