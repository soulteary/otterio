...
When you DELETE an object, all versions remain in the bucket and OtterIO adds a delete marker, as shown below:

![delete](https://raw.githubusercontent.com/soulteary/OtterIO/main/docs/bucket/versioning/versioning_DELETE_versionEnabled.png)
...
![get](https://raw.githubusercontent.com/soulteary/OtterIO/main/docs/bucket/versioning/versioning_GET_versionEnabled.png)

GET requests by specifying a version ID as shown below, you can retrieve the specific object version `fae684da`.

![get_version_id](https://raw.githubusercontent.com/soulteary/OtterIO/main/docs/bucket/versioning/versioning_GET_versionEnabled_id.png)
...
![delete_version_id](https://raw.githubusercontent.com/soulteary/OtterIO/main/docs/bucket/versioning/versioning_DELETE_versionEnabled_id.png)

## Concepts
- All Buckets on OtterIO are always in one of the following states: unversioned (the default) and all other existing deployments, versioning-enabled, or versioning-suspended.
...
To enable versioning, you send a request to OtterIO with a versioning configuration with Status set to `Enabled`.
```
<VersioningConfiguration xmlns="http://s3.amazonaws.com/doc/2006-03-01/">
