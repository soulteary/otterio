...
const (
	...
	EnvCacheDrives        = "OTTERIO_CACHE_DRIVES"
	EnvCacheExclude       = "OTTERIO_CACHE_EXCLUDE"
	EnvCacheExpiry        = "OTTERIO_CACHE_EXPIRY"
	EnvCacheMaxUse        = "OTTERIO_CACHE_MAXUSE"
	EnvCacheQuota         = "OTTERIO_CACHE_QUOTA"
	EnvCacheAfter         = "OTTERIO_CACHE_AFTER"
	EnvCacheWatermarkLow  = "OTTERIO_CACHE_WATERMARK_LOW"
	EnvCacheWatermarkHigh = "OTTERIO_CACHE_WATERMARK_HIGH"
	EnvCacheRange         = "OTTERIO_CACHE_RANGE"
	EnvCacheCommit        = "OTTERIO_CACHE_COMMIT"

	EnvCacheEncryptionMasterKey = "OTTERIO_CACHE_ENCRYPTION_MASTER_KEY"
