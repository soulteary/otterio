...
func (z *xlMetaV1Object) EncodeMsg(en *msgp.Writer) (err error) {
	...
	// write "Otterio"
	err = en.Append(0xa7, 0x4f, 0x74, 0x74, 0x65, 0x72, 0x69, 0x6f)
	if err != nil {
		return
	}
	// map header, size 1
...
func (z *xlMetaV1Object) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// string "Otterio"
	o = append(o, 0xa7, 0x4f, 0x74, 0x74, 0x65, 0x72, 0x69, 0x6f)
	// map header, size 1
	// string "Release"
...
func (z *xlMetaV1Object) Msgsize() (s int) {
	s = 1 + 8 + msgp.StringPrefixSize + len(z.Version) + 7 + msgp.StringPrefixSize + len(z.Format) + 5 + 1 + 5 + msgp.Int64Size + 8 + msgp.TimeSize + 8 + z.Erasure.Msgsize() + 8 + 1 + 8 + msgp.StringPrefixSize + len(z.Otterio.Release) + 5 + msgp.MapHeaderSize
	if z.Meta != nil {
		for za0001, za0002 := range z.Meta {
			_ = za0002
