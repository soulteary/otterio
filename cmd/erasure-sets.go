...
func (s *erasureSets) CopyObjectPart(ctx context.Context, _, _, destBucket, destObject string, uploadID string, partID int,
	_ int64, _ int64, srcInfo ObjectInfo, _, dstOpts ObjectOptions) (partInfo PartInfo, err error) {
